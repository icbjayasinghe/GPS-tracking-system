...
app.listen(port, function(req,res){ 
    ...
    schedule.scheduleJob('00 05 12 * * *', function(req, res){
        var date = new Date(); 
    ...
    schedule.scheduleJob('00 04 16 * * *', function(req, res){
        var date = new Date(); 
        var date = date.toISOString();
        var d = date.substring(0,10);
    ...
    schedule.scheduleJob('00 05 16 * * *', function(req, res){
        var date = new Date(); 
        var date = date.toISOString();
        var d = date.substring(0,10);
    ...
    schedule.scheduleJob('00 06 16 * * *', function(req, res){
        var date = new Date(); 
        var date = date.toISOString();
        var d = date.substring(0,10);
    ...
    schedule.scheduleJob('00 13 15 * * *', function(req, res){
        var date = new Date(); 
        var date = date.toISOString();
        var d = date.substring(0,10);
    ...
    schedule.scheduleJob('00 11 15 18 * *', function(req, res){
        var date = new Date(); 
        var date = date.toISOString();
